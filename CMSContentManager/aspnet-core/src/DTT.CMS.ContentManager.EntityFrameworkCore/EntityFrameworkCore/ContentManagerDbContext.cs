...
public class ContentManagerDbContext :
    AbpDbContext<ContentManagerDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(ContentManagerConsts.DbTablePrefix + "CMSContents",
                ContentManagerConsts.DbSchema);
